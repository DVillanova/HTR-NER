...
python $WorkDir/scripts/IAM_generate_tagged_line_transcription.py 2 \
...
rm -rf $WorkDir/PREC-REC/ALT_18_NOT_PARENTHESIZED_NER-GT
mkdir $WorkDir/PREC-REC/ALT_18_NOT_PARENTHESIZED_NER-GT
cd $WorkDir/PREC-REC/ALT_18_NOT_PARENTHESIZED_NER-GT
...
rm -rf $WorkDir/PREC-REC/ALT_18_NOT_PARENTHESIZED_NER-DECODE
mkdir $WorkDir/PREC-REC/ALT_18_NOT_PARENTHESIZED_NER-DECODE
cd $WorkDir/PREC-REC/ALT_18_NOT_PARENTHESIZED_NER-DECODE
...
#NER NORMAL
python $WorkDir/scripts/calc_prec_rec.py ./ALT_18_NOT_PARENTHESIZED_NER-GT ./ALT_18_NOT_PARENTHESIZED_NER-DECODE >> $WorkDir/alt_not_parenthesized_res_exp.txt
python $WorkDir/scripts/alt_dist_edicion_custom_saturated.py ./ALT_18_NOT_PARENTHESIZED_NER-GT ./ALT_18_NOT_PARENTHESIZED_NER-DECODE >> $WorkDir/alt_not_parenthesized_res_exp.txt