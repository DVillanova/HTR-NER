...
#GENERATION OF .TXT FILES WITH LINE ID - TRANSCRIPTION
...
#NER NORMAL
python $ScriptsDir/calc_prec_rec.py ./ALT_18_NOT_PARENTHESIZED_NER-GT ./ALT_18_NOT_PARENTHESIZED_NER-DECODE >> $WorkDir/alt_not_parenthesized_res_exp.txt
python $ScriptsDir/alt_dist_edicion_custom_saturated.py ./ALT_18_NOT_PARENTHESIZED_NER-GT ./ALT_18_NOT_PARENTHESIZED_NER-DECODE >> $WorkDir/alt_not_parenthesized_res_exp.txt