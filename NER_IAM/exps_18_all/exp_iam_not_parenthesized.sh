...
python $ScriptsDir/IAM_generate_tagged_line_transcription.py 1 \
...
#Elinar the output to generate hypothesis with transcription 1-best and correct tagging
...
#NER NORMAL
python $ScriptsDir/calc_prec_rec.py ./18_NOT_PARENTHESIZED_NER-GT ./18_NOT_PARENTHESIZED_NER-DECODE >> $WorkDir/not_parenthesized_res_exp.txt
python $ScriptsDir/alt_dist_edicion_custom_saturated.py ./18_NOT_PARENTHESIZED_NER-GT ./18_NOT_PARENTHESIZED_NER-DECODE >> $WorkDir/not_parenthesized_res_exp.txt
