...
mkdir $WorkDir/PREC-REC/6_CONTINUOUS_NER-DECODE
cd $WorkDir/PREC-REC/6_CONTINUOUS_NER-DECODE
rm $WorkDir/PREC-REC/6_CONTINUOUS_NER-DECODE/*
...
mkdir $WorkDir/PREC-REC/6_CONTINUOUS_NER-GT
cd $WorkDir/PREC-REC/6_CONTINUOUS_NER-GT
rm $WorkDir/PREC-REC/6_CONTINUOUS_NER-GT/*
