...
#NER NORMAL
cd $WorkDir/PREC-REC
python $WorkDir/scripts/calc_prec_rec.py ./ALT_6_NOT_PARENTHESIZED_NER-GT ./ALT_6_NOT_PARENTHESIZED_NER-DECODE >> $WorkDir/alt_not_parenthesized_res_exp.txt
python $WorkDir/scripts/alt_dist_edicion_custom_saturated.py ./ALT_6_NOT_PARENTHESIZED_NER-GT ./ALT_6_NOT_PARENTHESIZED_NER-DECODE >> $WorkDir/alt_not_parenthesized_res_exp.txt