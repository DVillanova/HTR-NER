...
python $ScriptsDir/fix_separate_symb_output_alt.py $TmpDir/decode/lattices/SeparateSimbols-wordtest.txt $TmpDir/decode/lattices/fixed_SeparateSymbols-wordtest.txt
python $ScriptsDir/fix_separate_symb_output_alt.py $TmpDir/decode/lattices/SeparateSimbols-word.txt $TmpDir/decode/lattices/fixed_SeparateSymbols-word.txt
